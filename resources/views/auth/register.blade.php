...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-auto">
            <img src="/svg/1437245.svg" class="rounded-circle" style="height: 200px; width: 200px">
        </div>
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-uppercase text-xl-center font-weight-bold">{{ __('Register') }}</div>
